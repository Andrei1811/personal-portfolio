    ...
    const experiences = [
        {
            ...
            skills: ["Full-Stack Web Development", "API Integration & Development", "Responsive UI/UX Design", "Database Management", "Version Control"],
        },
    {
          ...
          >
            ...
            <div
              className={cn(
                ...
                "left-0 -translate-x-1/2 md:translate-y-0",
              )}
            ></div>
            ...
            <div
              className={cn(
                ...
                mounted &&
                  inView &&
                  (index % 2 === 0 ? "md:transform md:translate-x-4" : "md:transform md:-translate-x-4"),
            ...
            >
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  {exp.skills.map((skill, skillIndex) => (
                    <span
                      key={skillIndex}
                      className="text-xs bg-gray-800 text-blue-400 px-2 py-1 rounded-full border border-gray-700"
                    >
                      {skill}
                    </span>
                  ))}
