    ...
    const skillCategories = [
        ...
        },
        {
            ...
            skills: [
                ...
                { name: "VMware / Virtualization", level: 75 },
                { name: "Dell Servers, RAID & Storage", level: 85 },
                { name: "iDRAC / iLO / BMC", level: 80 },
            ],
        },
        {
            ...
            skills: [
                ...
                { name: "Spring / Spring Boot", level: 50 },
        ...
        },
        {
            ...
            skills: [
                { name: "Backend Systems Engineering", level: 90 },
                { name: "API Design & Integration", level: 60 },
                { name: "Database Management", level: 95 },
                { name: "Automated Testing & Debugging", level: 80 },
                { name: "Data Transformation & ETL", level: 80 },
                { name: "Reporting & Process Automation", level: 90 },
                { name: "Infrastructure Troubleshooting", level: 90 },
                { name: "System Log & Error Analysis", level: 90 },
                { name: "Incident Analysis & Root Cause Investigation", level: 95 },
                { name: "Technical Documentation & Communication", level: 90 },
            ],
        },
    ]
